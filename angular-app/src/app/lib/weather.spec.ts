import { JAKARTA, formatTemp, formatUpdatedAt, formatWind, interpretWeatherCode, openMeteoUrl, toWeatherData } from './weather';
...
describe('weather lib', () => {
  ...
  it('parses Open-Meteo responses into WeatherData', () => {
    const data = toWeatherData({
      current: {
        temperature_2m: 30.2,
