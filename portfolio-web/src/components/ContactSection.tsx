  ...
  return (
    <section id="contact" className="py-20 px-5 bg-blue-900">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-lg text-blue-300 mb-14">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-8 mb-12">
          <div className="flex flex-col items-center gap-2">
            ...
            <a
              href="mailto:yuko.pangestu@gmail.com"
              className="text-blue-300 hover:text-white text-base transition-colors underline underline-offset-2"
            >
              yuko.pangestu@gmail.com
            </a>
          </div>
          <div className="flex flex-col items-center gap-2">
            <FaMapMarkerAlt size={28} className="text-blue-400" />
            <span className="text-white text-base">Jakarta, Indonesia</span>
          </div>
        </div>
        ...
        <div className="flex justify-center gap-3 mb-16">
          {socials.map(({ Icon, href, label }) => (
            <a
              ...
              aria-label={label}
              className="w-13 h-13 w-14 h-14 rounded-full border border-white/30 flex items-center justify-center text-white hover:border-white hover:bg-white/10 transition-all"
            >
              <Icon size={22} />
            </a>
          ))}
