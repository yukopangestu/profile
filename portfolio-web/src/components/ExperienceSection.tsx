  ...
  return (
    <section id="experience" className="py-20 px-5 bg-blue-50">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-3xl font-bold text-blue-900 text-center mb-2">Professional Journey</h2>
        <p className="text-gray-400 text-center mb-14">My career progression and achievements</p>
            ...
            {experiences.map((exp, i) => (
              <div key={i} className="flex gap-6">
                ...
                <div className="flex-shrink-0 w-7 flex justify-center">
                  <div className="w-3.5 h-3.5 rounded-full bg-blue-700 border-2 border-white shadow ring-2 ring-blue-200 mt-1.5 z-10" />
                </div>

                {/* Content */}
                <div className="flex-1 bg-white rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
                  <h3 className="text-base font-bold text-blue-900 mb-1">{exp.role}</h3>
