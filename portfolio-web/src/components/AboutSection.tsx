  ...
  return (
    <section id="about" className="py-20 px-5 bg-blue-50">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-3xl font-bold text-blue-900 text-center mb-2">About Me</h2>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="grid grid-cols-2 gap-4 lg:w-80 flex-shrink-0">
            {stats.map(stat => (
              ...
              >
                <p className="text-4xl font-extrabold text-blue-800 mb-1">{stat.number}</p>
          ...
          <div className="bg-white rounded-xl p-7 shadow-sm flex-1">
            <h3 className="text-lg font-bold text-blue-900 mb-4">Building Digital Excellence</h3>
