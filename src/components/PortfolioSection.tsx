      ...
      <div className="max-w-content mx-auto px-5 sm:px-6 md:px-14 py-14 sm:py-16 md:py-[88px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-[22px]">
          {portfolioItems.map(item => (
            ...
            >
              <div className="relative w-full h-[180px] sm:h-[200px] border-b border-term-dim bg-terminal-alt">
                <Image
                  src={item.image}
                  alt={item.title}
                  fill
              ...
              <div className="p-5">
                ...
                <h3 className="m-0 mb-2 text-[18px] sm:text-[19px] font-bold">{item.title}</h3>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-5 sm:gap-6 mt-5 sm:mt-[26px] bg-[linear-gradient(90deg,rgba(47,111,224,0.18),rgba(47,111,224,0.05))] border border-term-mid rounded-lg px-5 sm:px-6 md:px-8 py-6 sm:py-7">
          <div className="min-w-0">
            <div className="font-mono text-[11.5px] text-terminal-blue mb-1.5">
              // always building
            </div>
            <div className="text-[18px] sm:text-[22px] font-bold">Have a complex problem?</div>
          ...
          <a
            ...
            className="bg-terminal-primary text-white px-6 sm:px-[26px] py-3.5 rounded font-mono text-[13px] font-medium whitespace-nowrap hover:bg-terminal-primary-hover transition-colors text-center shrink-0"
          >
            get in touch →
          </a>
        </div>
