    ...
    <>
      ...
      <section id="contact" className="border-t border-term-dim">
        <div className="max-w-content mx-auto px-6 md:px-14 py-16 md:py-[88px]">
          ...
          <h2 className="m-0 mb-11 text-[32px] md:text-[44px] font-bold tracking-[-0.02em]">
            Let&apos;s Connect<span className="text-terminal-primary">.</span>
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
            <div>
              <p className="m-0 mb-[34px] max-w-[480px] text-[15.5px] leading-[1.7] text-terminal-muted">
                I&apos;m always open to new opportunities, collaborations, and meaningful
                conversations about technology and leadership.
              </p>
              <div className="flex flex-col gap-[18px] font-mono text-[13.5px]">
                <div className="flex flex-wrap gap-3.5 items-baseline">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3.5 font-mono text-[13px]">
                {socials.map(({ href, label }) => (
                  <a
                    ...
                    className="border border-term-mid rounded-md px-[18px] py-4 text-terminal-soft flex justify-between items-center hover:border-terminal-blue hover:text-white transition-colors"
                  >
                    <span>{label}</span>
      ...
      <section className="border-t border-term-dim bg-[radial-gradient(ellipse_50%_70%_at_50%_100%,rgba(47,111,224,0.18),transparent)]">
        <div className="max-w-content mx-auto px-6 md:px-14 py-20 md:py-24 text-center">
          <div className="font-mono text-[12.5px] text-terminal-blue mb-[18px]">
            // philosophy: code is the modern architecture of human experience
          </div>
          <h2 className="m-0 mx-auto mb-5 max-w-[640px] text-[36px] md:text-[52px] font-bold leading-[1.08] tracking-[-0.02em]">
            Ready to build something great?
          </h2>
          <p className="m-0 mx-auto mb-[38px] max-w-[540px] text-[15.5px] leading-[1.7] text-terminal-muted">
          ...
          <div className="flex flex-wrap gap-3.5 justify-center font-mono text-[13.5px]">
            <a
              href="mailto:yuko.pangestu@gmail.com"
              className="bg-terminal-primary text-white px-[30px] py-[15px] rounded font-medium hover:bg-terminal-primary-hover transition-colors"
            >
              send an email
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="border border-term-soft text-terminal-soft px-[30px] py-[15px] rounded hover:border-terminal-blue hover:text-white transition-colors"
            >
              view linkedin
            </a>
          </div>
      ...
      <footer className="border-t border-term-dim">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 max-w-content mx-auto px-6 md:px-14 py-8 font-mono text-xs text-terminal-faint text-center md:text-left">
          <div>
